...
::: {.cell-output .cell-output-stderr}
    Skipping install of 'ds4owdanalytics' from a github remote, the SHA1 (f0294f5a) has not changed since last install.
      Use `force = TRUE` to force installation
:::

::: {.cell-output .cell-output-stderr}
    Skipping install of 'undpcomposite' from a github remote, the SHA1 (d9ab8850) has not changed since last install.
      Use `force = TRUE` to force installation
:::
...
scientist and statistician with diverse experience across industry,
government, and consulting sectors, Adriana is passionate about data
visualization and improving data communication. Her skills are helping
