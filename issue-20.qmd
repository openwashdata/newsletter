...
Our latest blog post by [Adriana](https://openwashdata.org/about/adriana/) analyzes registration data from the upcoming "Data Science for openwashdata" (ds4owd) course. The data shows:
...
We're beta testing a new R package by [Nicoló](https://openwashdata.org/about/nicolo/) called `fairenough` that will streamline our data publication process. This package leverages LLM tools like the R package `elmer` to help ensure our datasets meet FAIR (Findable, Accessible, Interoperable, Reusable) data principles.
